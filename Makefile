...
casper_files:=recommended_target_hash-spec.k \
              ...
              vote-1-2-3-4-5-6-all-success-1-spec.k \
              vote-1-2-3-4-5-6-all-success-2-spec.k \
...
$(specs_dir)/casper/vote-1-2-3-4-5-6-all-success-1-spec.k: $(casper_tmpls) casper/casper-spec.ini
	python3 resources/gen-spec.py $^ vote-1-2-3-4-5-6-all-success-1 recommended_target_hash proc_reward-1 proc_reward-2 vote-1-2-3-4-5-6-all-success-1> $@

$(specs_dir)/casper/vote-1-2-3-4-5-6-all-success-2-spec.k: $(casper_tmpls) casper/casper-spec.ini
	python3 resources/gen-spec.py $^ vote-1-2-3-4-5-6-all-success-2 recommended_target_hash proc_reward-1 proc_reward-2 vote-1-2-3-4-5-6-all-success-2 > $@
