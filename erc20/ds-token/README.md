...
We present a formal verification of [DSToken ERC20][src] token contract.
...
https://github.com/dapphub/ds-token/tree/bb98ff4841e82137efc9690b9e1cf77e85fdd0bb/src,
...
We took the [source code][src] and the additional libraries [ds-auth], [ds-math], [ds-stop] and [ds-note], and compiled it to the EVM bytecode using solc compiler (of the version `0.4.18+commit.9cf6e910.Linux.g++`).
