...
# export OPTS+=" --debug-z3-queries"
  ...
  kprove $OPTS -m VERIFICATION    --branching-allowed 9  --boundary-cells k    ~/deposit2/verified-smart-contracts/specs/java/deposit/deposit-calldata-decoding-revert-spec.k

  kprove $OPTS -m VERIFICATION    --branching-allowed 1  --boundary-cells k    ~/deposit2/verified-smart-contracts/specs/java/deposit/supportsInterface-success-spec.k
  kprove $OPTS -m VERIFICATION    --branching-allowed 1  --boundary-cells k    ~/deposit2/verified-smart-contracts/specs/java/deposit/supportsInterface-revert-spec.k
