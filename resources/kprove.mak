...
KPROVE:=$(K_BIN)/kprove -v -d $(KEVM_REPO_DIR)/.build/java -m VERIFICATION --z3-impl-timeout 500 --format-failures \
        --boundary-cells k,pc --no-alpha-renaming --no-exc-wrap $(KPROVE_OPTS)
