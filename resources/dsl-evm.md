...
Contracts can declare and generate the events, which will be compiled down to EVM bytecode using the EVM log instructions.
...
eDSL provides `#abiEventLog`, a notation to specify the EVM logs in the high-level events, defined below.
