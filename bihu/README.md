...
The modified and inlined source code for each target function:

* [collectToken-inlined.sol]
* [forwardHotWallet-inlined.sol]

The EVM (runtime) bytecode generated by the Remix Solidity compiler:

* [collectToken-inlined.sol.bytes]
* [forwardHotWallet-inlined.sol.bytes]

The Remix IDE-generated Gist links:

* collectToken-inlined.sol: 
* forwardHotWallet-inlined.sol: https://gist.github.com/anonymous/b7773008aa9dc75815f1c6ecfb7224a0
