...
def gen(sepc_template, rule_template, spec_ini, pgm_ini, spec_name, rule_name_list):
...
if __name__ == '__main__':
    if len(sys.argv) < 7:
        print("usage: <cmd> <spec-template> <rule-template> <spec_ini> <pgm_ini> <spec_name> <rule_name_list>")
        sys.exit(1)
